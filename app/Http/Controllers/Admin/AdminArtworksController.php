    ...
    public function store(Request $request)
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'creation_year' => 'nullable|integer|min:1000|max:' . (date('Y') + 5),
                'description'   => 'nullable|string',
                'height'        => 'nullable|numeric|min:0',
                'width'         => 'nullable|numeric|min:0',
                'medium'        => 'nullable|string|max:255',
                'technique_notes' => 'nullable|string|max:2000',
                'dimensions'    => 'nullable|string|max:255',
                'depth'         => 'nullable|string|max:100',
                'weight'        => 'nullable|string|max:100',
                'edition_info'  => 'nullable|string|max:255',
                'condition'     => 'nullable|string|max:100',
                'provenance'    => 'nullable|string|max:2000',
                'is_framed'     => 'boolean',
                'framing_details' => 'nullable|string|max:1000',
