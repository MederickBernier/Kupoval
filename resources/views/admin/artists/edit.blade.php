...
@section('content')
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-4xl mx-auto">
        <h2 class="text-2xl font-semibold mb-6 text-gray-800">{{ __('admin/artists.edit_title', ['name' => $artist->name]) }}
        </h2>
            ...
            <div class="border-t pt-6 mt-6">
                ...
                <div>
                    ...
                    <textarea name="artist_statement" id="artist_statement"
                        ...
                        placeholder="{{ __('admin/artists.artist_statement_placeholder') }}">{{ old('artist_statement', $artist->artist_statement) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="exhibition_history" id="exhibition_history"
                        ...
                        placeholder="{{ __('admin/artists.exhibition_history_placeholder') }}">{{ old('exhibition_history', $artist->exhibition_history) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="awards" id="awards"
                        class="editor w-full p-3 border rounded-lg focus:ring focus:ring-blue-300 mt-1 h-32"
                        placeholder="{{ __('admin/artists.awards_placeholder') }}">{{ old('awards', $artist->awards) }}</textarea>
                    @error('awards')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="studio_location" id="studio_location"
                            ...
                            value="{{ old('studio_location', $artist->studio_location) }}">
                ...
                <div>
                    ...
                    <input type="text" name="specialties" id="specialties"
                        class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300 mt-1"
                        placeholder="{{ __('admin/artists.specialties_placeholder') }}"
                        value="{{ old('specialties', is_array($artist->specialties) ? implode(', ', $artist->specialties) : '') }}">
                ...
                <div>
                    ...
                    <input type="text" name="techniques" id="techniques"
                        class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300 mt-1"
                        placeholder="{{ __('admin/artists.techniques_placeholder') }}"
                        value="{{ old('techniques', is_array($artist->techniques) ? implode(', ', $artist->techniques) : '') }}">
                    <p class="text-sm text-gray-600 mt-1">{{ __('admin/artists.comma_separated') }}</p>
                    @error('techniques')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="url" name="profile_video_url" id="profile_video_url"
                        ...
                        value="{{ old('profile_video_url', $artist->profile_video_url) }}" onblur="ensureHttps(this)">
            ...
            <div class="border-t pt-6 mt-6">
                ...
                <div>
                    ...
                    <input type="url" name="website" id="website"
                        class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300 mt-1"
                        value="{{ old('website', $artist->website ?? '') }}" onblur="ensureHttps(this)">
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <div class="w-24 h-24 border rounded-lg overflow-hidden">
                        <img id="photoPreview" src="{{ asset($artist->photo) }}" class="w-full h-full object-cover"
                            alt="Current Photo">
                    </div>
                    <div class="flex-1">
                        <label for="photo"
                ...
                <div class="flex justify-between items-center mt-8">
                    ...
                    <button type="submit"
                        class="px-5 py-3 bg-blue-500 text-white font-bold rounded-lg hover:bg-blue-600">
