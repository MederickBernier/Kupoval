<div x-show="openOrdersModal"
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-[500px] relative">
        ...
        <h2 class="text-xl font-semibold mb-4">User Orders</h2>
            ...
            <div class="overflow-y-auto max-h-80">
                <table class="w-full border-collapse border border-gray-300">
                    <thead class="bg-gray-200">
                        <tr>
                            <th class="px-4 py-2 text-left border">Order #</th>
        ...
        <template x-if="selectedUser && selectedUser.orders.length === 0">
            <p class="text-gray-500 bg-neutral p-3 rounded">No orders found for this user.</p>
        </template>

        <div class="mt-4 flex justify-end">
            <button @click="openOrdersModal = false" class="px-4 py-2 bg-gray-200 rounded-lg hover:bg-gray-300">Close</button>
        </div>
    </div>
</div>
