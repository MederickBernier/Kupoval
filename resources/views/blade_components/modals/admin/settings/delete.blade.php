<div x-show="openDeleteModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4">
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md sm:max-w-lg">
        ...
        <form action="#" method="POST">
            ...
            <div class="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-2">
                <button type="button" @click="openDeleteModal = false" class="px-4 py-2 border rounded w-full sm:w-auto">Cancel</button>
                <button
                    type="submit"
